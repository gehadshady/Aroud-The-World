...
export default function CountryList({ countries }: { countries: Country[] }) {
  return countries.length > 0 ? (
    <div className="grid grid-cols-1 justify-between justify-items-center gap-8 py-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {countries.map((country) => (
        <CountryCard key={country.id} country={country} />
      ))}
    </div>
    ...
    <>
      ...
      >
        ...
        <path
          ...
          // stroke="black"
          className="stroke-[#1C1D21] dark:stroke-gray-100"
          stroke-width="7"
        />
        <path
        ...
        <path
          ...
          className="dark:fill-[#F3F4F6]dark:stroke-[#374151] fill-[#F9FAFB] stroke-[#8A8A8A]"
          // fill="#F9FAFB"
          // stroke="#8A8A8A"
          stroke-width="6"
        ...
        <path
          ...
          className="fill-[#161D21] dark:fill-[#374151]"
          // fill="#161D21"
        />
        <path
          ...
          className="stroke-[#263238] dark:stroke-[#F3F4F6]"
          // stroke="#263238"
          stroke-miterlimit="10"
        />
        <path
      ...
      <h1 className="mt-10 text-4xl font-medium md:mt-0">No results found</h1>
